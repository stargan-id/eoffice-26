        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-900">JAGA GIZI</h1>
                <p className="text-sm text-slate-600">Sistem Informasi Gizi</p>
              </div>
            </div>
            ...
            <div className="space-y-6 text-center lg:text-left">
              <div className="space-y-4">
                <div className="inline-flex items-center px-3 py-1 rounded-full bg-blue-100 text-blue-800 text-sm font-medium">
                  ...
                  Sistem Terpadu Monitoring Gizi
                </div>
                <h1 className="text-4xl lg:text-5xl font-bold text-slate-900 leading-tight">
                  Selamat Datang di
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600"> JAGA GIZI</span>
                </h1>
                <p className="text-lg text-slate-600 max-w-lg mx-auto lg:mx-0">
                  Platform digital untuk monitoring, evaluasi, dan pelaporan program gizi nasional yang terintegrasi dan real-time.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg mx-auto lg:mx-0">
                <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm border border-slate-200">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900">Data Real-time</h3>
                    <p className="text-sm text-slate-600">Monitoring langsung</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm border border-slate-200">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Enkripsi tingkat tinggi</p>
                  </div>
                </div>
              </div>
              ...
              <div className="hidden lg:block relative">
                <div className="w-full h-64 bg-gradient-to-r from-blue-600/10 to-indigo-600/10 rounded-2xl flex items-center justify-center">
                  <div className="text-center space-y-2">
                    ...
                    <p className="text-slate-600 font-medium">Analitik & Pelaporan</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <Card className="w-full max-w-md shadow-xl border-0 bg-white/95 backdrop-blur-sm">
                <CardHeader className="space-y-1 pb-6">
                  ...
                  <CardDescription className="text-center text-slate-600">
                    Gunakan akun resmi Anda untuk mengakses JAGA GIZI
                  </CardDescription>
                </CardHeader>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between space-y-2 sm:space-y-0">
            <p className="text-sm text-slate-600">
              © 2024 Badan Gizi Nasional RI. Semua hak dilindungi.
            </p>
